			...
			>
				...
				>
					<label className="flex flex-col">
						<span className="text-white font-medium mb-4">Votre Nom et Prenoms.</span>
						<input
							type="text"
							name="name"
							value={form.name}
							onChange={handleChange}
							placeholder="Quel est votre nom et prenoms ?"
					...
					<label className="flex flex-col">
						...
						<textarea
							...
							value={form.message}
							onChange={handleChange}
							placeholder="Veuillez laissez votre message"
							className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
						/>
					</label>
					<button
